...
def getFeatures(cached, limit):
    if not cached:
        features_util.createDataset("data/rnn2_features", extractFeatures, limit)
    titles_train, X_train, Y_train, titles_test, X_test, Y_test = features_util.getCachedDataset("data/rnn2_features")
